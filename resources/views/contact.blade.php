    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 via-indigo-950 to-slate-900 px-4">
        <div class="container mx-auto max-w-5xl">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">Have a project in mind or want to know more about my
                    services? Feel free to reach out.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <!-- Contact Form -->
                <div
                    class="bg-gray-800 rounded-xl p-8 shadow-2xl border border-gray-700 transform hover:scale-[1.01] transition-all duration-300">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea id="message" name="message" rows="5"
                                    class="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent"
                                    placeholder="Tell me about your project, ask a question, or just say hi!" required></textarea>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-800 rounded-xl p-8 shadow-2xl border border-gray-700">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div
                                    class="w-10 h-10 rounded-full bg-teal-400/20 flex items-center justify-center mr-4 mt-1">
                    ...
                    <div class="bg-gray-800 rounded-xl p-8 shadow-2xl border border-gray-700">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <a href="https://gitlab.com/muhammadkamilcsl19" target="_blank"
                                ...
                                <i class="fab fa-gitlab text-2xl text-white mb-2"></i>
