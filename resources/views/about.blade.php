...
@section('content')
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 via-indigo-950 to-slate-900 px-4">
        <div class="container mx-auto max-w-5xl">
            <div class="text-center mb-12">
                <h1
                    class="text-4xl md:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500">
                    About Me</h1>
                <div class="w-24 h-1 bg-gradient-to-r from-teal-400 to-blue-500 mx-auto rounded-full mb-6"></div>
                <p class="text-xl text-gray-300 max-w-3xl mx-auto">My journey, passion, and vision in the world of
                    technology.</p>
            </div>
        </div>
    </section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div class="md:col-span-1">
                        <div class="relative mb-8">
                            <div class="rounded-xl overflow-hidden border-2 border-teal-400">
                                <img src="{{ asset('images/profile-about.jpg') }}" alt="Muhammad Kamil"
                                    class="w-full h-auto"
                        ...
                        <div class="space-y-5">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-white">Information Technology, B.Eng</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-white">Aceh, Aceh Barat, Indonesia</p>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-700">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <a href="https://linkedin.com/in/muhammadkamil" target="_blank"
                                    class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center text-white hover:bg-blue-600 transition-all transform hover:scale-110">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a href="https://twitter.com/muhammadkamil" target="_blank"
                                    class="w-10 h-10 rounded-full bg-blue-400 flex items-center justify-center text-white hover:bg-blue-500 transition-all transform hover:scale-110">
                                    <i class="fab fa-twitter"></i>
                                </a>
                                <a href="https://instagram.com/muhammadkamil" target="_blank"
                                    class="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center text-white hover:opacity-90 transition-all transform hover:scale-110">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="space-y-6 text-gray-300">
                            <p class="text-lg">
                                Hello! I'm <span class="text-teal-400 font-semibold">Muhammad Kamil</span>, a passionate
                                full-stack developer with a lifelong fascination for technology. My journey began much
                                earlier than my professional career—it started when I was just a 10-year-old boy captivated
                                by the glowing screen of a computer.
                            </p>

                            <h3 class="text-xl font-bold text-teal-400 mt-8">The Early Days</h3>
                            <p>
                                As a child, while most of my friends were playing outside, I found myself drawn to the
                                family computer. At just 10 years old, I would spend hours exploring different programs,
                                figuring out how things worked, and being amazed at how a simple machine could create such
                                dynamic experiences. What began as playing simple games soon evolved into curiosity about
                                how these games were made.
                            </p>

                            <p>
                                By my early teens, I had taught myself basic HTML and CSS, creating simple websites just for
                                fun. The ability to type a few lines of code and watch them transform into visual elements
                                on screen felt like magic—a magic I was determined to master.
                            </p>

                            <h3 class="text-xl font-bold text-teal-400 mt-8">Education & Growth</h3>
                            <p>
                                My passion for technology naturally led me to pursue a degree in Computer Science, where I
                                built a strong foundation in programming principles, algorithms, and software design. During
                                college, I immersed myself in various programming languages and frameworks, but web
                                development always held a special place in my heart.
                            </p>

                            <p>
                                What I love most about programming is the perfect blend of logic and creativity it requires.
                                Building solutions that are not only functional but also intuitive and elegant brings me
                                immense satisfaction. I believe that great software should solve real problems while
                                providing a seamless user experience.
                            </p>

                            <h3 class="text-xl font-bold text-teal-400 mt-8">Professional Journey</h3>
                            <p>
                                With over 3 years of experience, I've had the privilege of working on diverse projects
                                across different industries. From developing e-commerce platforms to creating custom content
                                management systems, each project has added valuable skills to my toolkit.
                            </p>

                            <p>
                                I specialize in Laravel, Vue.js, and React, focusing on creating scalable and maintainable
                                applications that stand the test of time. Clean code, thorough testing, and thoughtful
                                architecture are principles I hold dear in my work.
                            </p>

                            <h3 class="text-xl font-bold text-teal-400 mt-8">Philosophy & Vision</h3>
                            <p>
                                I believe that technology should enhance human experiences, not complicate them. This
                                philosophy guides my approach to every project—focusing on user needs, accessibility, and
                                intuitive design. The best technology is the kind that feels invisible while empowering
                                users to achieve their goals.
                            </p>

                            <p>
                                Looking ahead, I'm excited about continuing to grow as a developer, exploring emerging
                                technologies, and creating solutions that make a positive impact. That curious 10-year-old
                                boy still lives within me, driving me to learn, explore, and create with the same wonder and
                                enthusiasm.
                            </p>
                        </div>
                        ...
                        <div class="mt-10 pt-6 border-t border-gray-700">
                            ...
                            <p class="text-gray-300 mb-6">I'm always open to discussing new projects, creative ideas or
                                opportunities to be part of your vision.</p>
                            <a href="{{ route('contact') }}"
                                class="inline-block bg-gradient-to-r from-teal-400 to-teal-600 text-white font-medium py-3 px-8 rounded-lg transform transition-all hover:scale-105 hover:shadow-lg hover:from-teal-500 hover:to-teal-700">
    ...
    <section class="py-16 bg-slate-800 px-4">
        <div class="container mx-auto max-w-5xl">
            <div class="text-center mb-12">
                <h2
                    class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500 mb-4">
                    Skills & Expertise</h2>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-gradient-to-r from-teal-400 to-blue-500 h-2 rounded-full" style="width: 90%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-gradient-to-r from-teal-400 to-blue-500 h-2 rounded-full" style="width: 95%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-gradient-to-r from-teal-400 to-blue-500 h-2 rounded-full" style="width: 85%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-gradient-to-r from-teal-400 to-blue-500 h-2 rounded-full"
                                    style="width: 90%"></div>
                            </div>
                        </div>
                ...
                <div class="bg-gray-900 rounded-xl p-8 shadow-xl border border-gray-700">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="p-5 bg-gray-800 rounded-lg border border-gray-700">
                            ...
                            <p class="text-gray-400 text-sm">Creating responsive, user-friendly web applications with
                                modern frameworks.</p>
                        </div>
                        ...
                        <div class="p-5 bg-gray-800 rounded-lg border border-gray-700">
                            ...
                            <p class="text-gray-400 text-sm">Designing with mobile users in mind for optimal user
                                experience.</p>
                        </div>
                        ...
                        <div class="p-5 bg-gray-800 rounded-lg border border-gray-700">
                            ...
                            <p class="text-gray-400 text-sm">Creating robust APIs for seamless integration across
                                platforms.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto max-w-4xl relative z-10">
            <div class="bg-gray-800/50 backdrop-blur-md rounded-2xl p-10 border border-gray-700 shadow-2xl">
                <div class="text-center">
                    ...
                    <p class="text-gray-300 max-w-2xl mx-auto mb-8">I'm always looking for new challenges and opportunities
                        to create amazing digital experiences. Let's discuss how we can collaborate on your next project.
                    </p>
